...
struct HumanData
{
  ...
  HumanData() : id{0}, x{0}, y{0}, vx{0}, vy{0}, ang{0}, ox{0}, oy{0}, oz{0}, ow{1}
  {}

  HumanData(const int id, const double x, const double y, const double vx, const double vy, const double ang, const double ox, const double oy, const double oz, const double ow)
